...
def main(conf_name, gpu):
    ...
    for file_ind, input_file in enumerate(files):
        ...
        if gpu == 'all':
            ...
            os.system(f"& P:/Pragnesh/envs/pytorch/python.exe p:/Parth/pytorch-ZSSR/run_ZSSR_single_input.py {local_dir} {input_file} {ground_truth_file} {kernel_files_str} {cur_gpu} {conf_name} {res_dir}")
...
if __name__ == '__main__':
    ...
    main("X2_ONE_JUMP_IDEAL_CONF", "all")
